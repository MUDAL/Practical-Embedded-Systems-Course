...
namespace
{
	...
	bme280CompParam_t bme280;
	uint8_t rawAdcValue[ADC_REGISTER_SIZE];
	uint8_t bme280Calib00_25[CALIB_00_25_SIZE];
	uint8_t bme280Calib26_41[CALIB_26_41_SIZE]; 
	int32_t t_fine;

	void BME280_StoreCompensationParameters(uint8_t* calibReg1,
																					uint8_t* calibReg2,
...
void BME280::TakeMeasurements(void)
{
...
uint8_t BME280::GetTemperature(void)
{
	BME280::TakeMeasurements();
	return temperature;
}

uint8_t BME280::GetHumidity(void)
{
	BME280::TakeMeasurements();
	return humidity;
}
