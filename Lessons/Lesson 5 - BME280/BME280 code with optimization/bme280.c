...
{
	I2C1_Init();
	I2C1_Read(BME280_ADDR,CALIB_00_25_ADDR,bme280Calib00_25,CALIB_00_25_SIZE);
	//Read the first 7 calibration data of calib26_41 register of bme280
	I2C1_Read(BME280_ADDR,CALIB_26_41_ADDR,bme280Calib26_41,7);
	BME280_Store_Compensation_Parameters(bme280Calib00_25,bme280Calib26_41,&bme280);
}

void BME280_GetData(bme280_t* pSensorData)
{
	I2C1_WriteByte(BME280_ADDR,CTRL_HUM_ADDR,CTRL_HUM_OSRS_H_OVR16);
	I2C1_WriteByte(BME280_ADDR,CTRL_MEAS_ADDR,(CTRL_MEAS_OSRS_T_OVR16|CTRL_MEAS_MODE_FORCED1));
	I2C1_Read(BME280_ADDR, DATA_REG_ADDR, rawAdcValue, ADC_REGISTER_SIZE);
